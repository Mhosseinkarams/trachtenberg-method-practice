...
class FastMathApp:
    ...
    def show_categories(self, update: bool = True):
        ...
        for cat_key, info in CATEGORIES_INFO.items():
            # Use pre-calculated rules_by_system_category for O(1) filtering
            if not rules_by_system_category.get((self.selected_system, cat_key)):
                continue
    ...
    def show_rule_selector(self, category: str, update: bool = True):
        ...
        # Use pre-calculated rules_by_system_category
    ...
    async def next_problem(self, e=None):
        ...
        if self.mode == "Learn":
            ...
            # Granular update for the cards involved
    ...
    async def check_answer(self, e):
        ...
        # Granular update for the practice card
        self.practice_card.update()
