...
class FastMathApp:
    ...
    def show_categories(self, update: bool = True):
        ...
        for cat_key, info in CATEGORIES_INFO.items():
            # Optimized lookup by system and category
    ...
    def show_rule_selector(self, category: str, update: bool = True):
        ...
        # Optimized lookup for rules by system and category
    ...
    async def next_problem(self, e=None):
        ...
        # Granular update instead of full page.update()
    ...
    async def check_answer(self, e):
        ...
        self.practice_card.update() # Granular update reduces bridge traffic
