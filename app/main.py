...
class FastMathApp:
    ...
    def show_categories(self, update: bool = True):
        ...
        # Get pre-filtered rules for this system
        system_rules = rules_by_system_category.get(self.selected_system, {})

        for cat_key, info in CATEGORIES_INFO.items():
            if cat_key not in system_rules:
                continue
    ...
    def show_rule_selector(self, category: str, update: bool = True):
        ...
        # Use pre-filtered rules for this system and category
