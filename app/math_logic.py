...
_POWERS_OF_10 = [10**i for i in range(11)]
...
def gen_tracht_addition(num_operands=2, num_digits=3, **kwargs):
    ...
    for _ in range(num_operands):
        if num_digits == 0: # 0 means random
            ...
            d = num_digits
        operands.append(random.randint(_POWERS_OF_10[d-1], _POWERS_OF_10[d] - 1))
...
def gen_vedic_subtraction_base(num_digits=3, **kwargs):
    if num_digits == 0:
        ...
        d = num_digits
    base = _POWERS_OF_10[d]
    num = random.randint(_POWERS_OF_10[d-1], base - 1)
