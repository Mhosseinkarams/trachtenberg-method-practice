...
def to_persian_digits(n):
    # Performance Optimization: Use pre-calculated translation table
...
# Performance Optimization: Pre-calculate powers of 10 for random generation
_POW10 = [10**i for i in range(8)]
...
def gen_tracht_addition(num_operands=2, num_digits=3, **kwargs):
    ...
    for _ in range(num_operands):
        if num_digits == 0: # 0 means random
            ...
            d = num_digits
        # Performance Optimization: Use pre-calculated powers of 10
...
rules_by_category = {}
rules_by_method = {}
# Performance Optimization: Pre-calculate system-category mapping to avoid O(n) filtering in UI
