...
_POW10 = [1, 10, 100, 1000, 10000, 100000, 1000000]
...
def gen_tracht_addition(num_operands=2, num_digits=3, **kwargs):
    ...
    for _ in range(num_operands):
        if num_digits == 0: # 0 means random
            ...
            d = num_digits
        # Using pre-calculated powers of 10 for speed
...
rules_by_category = {}
rules_by_method = {}
# Optimization: Pre-calculate rule grouping by system and category to enable O(1) filtering in UI
